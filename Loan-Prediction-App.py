...
input_income_annum = st.number_input("Enter your Annual Income:")
input_loan_amount = st.number_input("Enter the Loan Amount:")
input_loan_term = st.slider("Select the term of loan in years", int(loan_data["loan_term"].min()), int(loan_data["loan_term"].max()))
input_cibil_score = st.number_input("Enter your CIBIL Score:", min_value=300,max_value=900)
input_residential_assets_value = st.number_input("Enter your Residential Assets Value:")
input_commercial_assets_value = st.number_input("Enter your Commercial Assets Value:")
input_luxury_assets_value = st.number_input("Enter your Luxury Assets Value:")
input_bank_asset_value = st.number_input("Enter the Bank Asset Value:")
